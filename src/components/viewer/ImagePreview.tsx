  ...
  return (
    <div className="p-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-600 mt-1 font-mono">{filePath}</p>
      </div>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4">
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p className="font-mono text-gray-900">{fileSizeKB} KB</p>
          </div>
          {imageSize && (
            <>
              <div>
      ...
      <div className="border border-gray-200 rounded-lg bg-white overflow-auto max-h-96 flex items-center justify-center">
        {imageError ? (
